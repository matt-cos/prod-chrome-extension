...
function backUpDeploy() {
	chrome.tabs.executeScript({
		code: 'document.getElementById("comment-textarea").value = "backing up and deploying";jQuery(".btn-post").click();'
	});
}
...
document.getElementById('b-u-dep').addEventListener('click', backUpDeploy);